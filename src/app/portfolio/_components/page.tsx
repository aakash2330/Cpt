            ...
            <div className="max-w-6xl mx-auto">
                <div className="relative">
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            <div className="absolute left-8 md:left-1/2 w-32 h-px bg-[#FFFFFF] transform -translate-y-1/2 hidden lg:block mt-[157px]"
                                style={{
                                    top: "350px",
                            ...
                            <div className={`w-full md:w-1/2 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'} mb-4 md:mb-0 mt-[100px] lg:mt-[350px]`}>
                                <div className="h-80">
                            ...
                            {/* Project details */}
                            <div className={`w-full md:w-1/2 ${index % 2 === 0 ? 'md:pl-48' : 'md:pl-12'} lg:mt-[400px]`}>
                                <div className="p-4 pl-16 md:pl-4">
                                    <h2 className="mb-2 text-sm sm:text-base font-semibold tracking-wide">{project.title}</h2>
                                    <p className="mb-2 text-sm sm:text-base font-semibold tracking-wide">{project.location}</p>
                                    <ul className="list-disc pl-5 space-y-2">
                                        {project.details.map((detail, detailIndex) => (
                                            <li key={detailIndex} className="text-xs max-w-sm">{detail.text}</li>
                                        ))}
                                    </ul>
                                </div>
                            </div>

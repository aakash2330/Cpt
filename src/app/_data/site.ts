...
export const sectors = [
  ...
  },
  {
    ...
    href: "/industries/multi-residential",
    image:
      "/Building Images/Sherway Tower - 205, Sherway Gardens Road, Toronto/25-One-Serway-Tower-4-interior-2-1.jpg",
    description: "New-build towers and occupied high-rise renovations.",
    cta: "View Multi-Residential",
  },
  {
    ...
    description:
      "Office fit-outs, medical office buildings, retail programs, and civic facilities.",
    cta: "View Commercial",
  },
];
...
export const testimonials = [
  {
    quote:
      "One of the key reasons we continue to work with CPT is their ability to respond quickly when project demands increase. Whether we require a large workforce on short notice, such as mobilizing 50 drywallers, or weekend manpower to meet critical deadlines, CPT has always shown up and delivered.",
    attribution: "CEO, Chamberlain Group of Companies",
  },
  {
    quote:
      "The owner, Papi Kasaj, along with his entire team, has always been transparent, responsive, and exceptionally easy to work with. Communication has been clear and proactive, and their team consistently demonstrated a solutions-oriented approach that we greatly value.",
    attribution: "Partner, Novi Builds",
  },
  {
    quote:
      "Their ability to complete large-scale projects with minimal disruption to residents have consistently exceeded expectations.",
    attribution: "Property Manager, FirstService Residential",
  },
];
...
export const associations = [
  ...
  },
  {
    ...
    logo: "/Seals/TCA/TCA 150 Year Logo - all white.png",
    mark: null,
  },
  {
    name: "Canadian Construction Association",
    logo: "/Seals/CCA/CCA_En_reverse.png",
    mark: null,
  },
  {
...
export const principles = [
  {
    ...
    body: "Hard scopes, compressed schedules, difficult regulatory environments. When a project presents a problem, the crew finds a way through and executes. No escalation. No delay.",
  },
  {
    title: "Do It Right",
    body: "Right materials. Right tradespeople. Right finish. No shortcuts, no excuses, even when no one's watching.",
  },
  {
    title: "Full Responsibility",
    body: "Every deadline, outcome, and issue on a CPT scope belongs to CPT. Problems surface early and get resolved before they reach the client.",
  },
  {
    title: "Win Together",
    body: "The crew on site and the client awarding the work are working toward the same outcome. Open communication. Consistent follow-through. No surprises.",
  },
  {
    title: "Safety First",
    body: "Every person goes home safe. That's the one thing we'll never compromise on.",
  },
];
...
export const industryPages = {
  hospitality: {
    ...
    groups: [
      ...
      },
      {
        title: "Food & Beverage",
        intro:
          "National QSR and casual dining brands control their build-out standards tightly across locations. The finish requirements are specific and consistently enforced.",
        projects: [
          {
            name: "A&W",
            location: "Ontario program details in confirmation",
            image: "/Pogue Mahone/image1.webp",
            meta: "Locations / scope summary / final photography under client confirmation",
            status: "Confirmation in progress",
            body: "This food and beverage program is held as an active portfolio record while locations, scope summary, and approved photography are confirmed for publication.",
          },
          {
            name: "Kelsey's",
            location: "Ontario program details in confirmation",
  ...
  healthcare: {
    ...
    image: "/Building Images/Arcavia Long-Term Care – Orillia, ON/1.png",
    cta: "Discuss an LTC & Healthcare Project",
    groups: [
      {
        title: "Long-Term Care & Healthcare",
        intro: "",
  ...
  residential: {
    eyebrow: "Multi-Residential",
    title: "Floor by Floor. Unit by Unit.",
    intro:
      "New-build towers run on floor-cycle discipline: sequenced throughput against a GC's master schedule, no slippage. Occupied renovations are a different operation entirely: resident coordination, noise and dust containment, elevator scheduling, and work windows that do not disrupt people living in the building. CPT has delivered both.",
    image:
      "/Building Images/Sherway Tower - 205, Sherway Gardens Road, Toronto/25-One-Serway-Tower-4-interior-3-1.jpg",
    cta: "Discuss a Multi-Residential Project",
    groups: [
      {
        title: "Multi-Residential",
        intro: "",
        projects: [
          ...
          {
            name: "Additional Multi-Residential Work",
            location: "",
            image: "/sherway2.jpg",
            meta: "Project names / locations / scale metrics under confirmation",
            status: "Confirmation in progress",
            body: "Additional multi-residential records are being prepared for publication once names, locations, scale metrics, and approved photography are confirmed.",
          },
        ],
      },
    ],
  ...
  commercial: {
    ...
    title: "Every Scope. Same Standard.",
    intro:
      "Office fit-outs, medical office buildings, retail programs, and civic facilities. The environment changes. The documentation, crew accountability, and finish standard do not.",
    image: "/commercial.jpg",
    ...
    groups: [
      {
        ...
        projects: [
          {
            name: "Commercial & Institutional Project List",
            location: "Ontario records in confirmation",
            image: "/industrial.jpg",
            meta: "Names / locations / scale metrics / scope summaries under confirmation",
            status: "Confirmation in progress",
            body: "Commercial and institutional records are being prepared for publication once the confirmed list, scale metrics, scope summaries, and approved photography are available.",
          },
        ],
      },
    ],

    ...
    groups: [
      ...
      },
      {
        ...
        projects: [
          {
            name: "A&W",
            location: "Locations pending confirmation",
            image: "/Pogue Mahone/image1.webp",
            meta: "Scope summary pending",
            body: "Project locations, scope summary, and final photography are pending client confirmation.",
          },
          {
            name: "Kelsey's",
            location: "Locations pending confirmation",
    ...
    groups: [
      {
        ...
        projects: [
          ...
          },
          {
            ...
            body: "Additional multi-residential project entries will be added once names, locations, scale, and photography are confirmed.",
          },
        ],
      },
    ],
    ...
    groups: [
      {
        ...
        projects: [
          {
            name: "Project Entries Pending",
            location: "Details pending confirmation",
            image: "/industrial.jpg",
            meta: "Name / location / scale / scope summary pending",
            body: "Commercial and institutional project entries will be added once the confirmed list, scale metrics, scope summaries, and photography are available.",
          },
        ],
      },
    ],
